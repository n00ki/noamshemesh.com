<script>
	...
	async function handleSubmit(form) {
		...
		try {
			const res = await fetch('/contact/contact.json', {
				method: 'POST',
				body: formData
			});
		...
		<div>
			<form on:submit|preventDefault={handleSubmit}>
				...
				>
					...
					<div class="">
						<div>
							<label for="name" class="uppercase text-sm text-gray-600 font-bold">Name</label>
							<input
						...
						<div class="mt-8">
							<label for="content" class="uppercase text-sm text-gray-600 font-bold">Message</label>
							<textarea
								name="content"
								required
